...
Without the decoder adapter the median-matched reference raises similarity to the real recordings by +0.091 in 36 of 36 clips and style similarity by +0.114 in 36 of 36 at the same word error rate; with the adapter the gain shrinks to +0.031 (29 of 36) and the word error rate rises 0.9 points. Two path-blind listening tests of 36 pairs split by the decoder adapter: without it the listener preferred the median-matched reference 21 to 15 (timbre 19 to 16, one tie; naturalness 4.28 against 4.14, audio quality 4.42 against 4.33); with it the old reference won 20 to 16 (timbre 19 to 12 with 5 ties). The median pitch of the median-matched rows, 157 to 158 Hz, overshoots the speaker's 144 Hz median while the old reference lands on 140 to 150 Hz, and stacking the adapter on top of the higher reference is what the listener disliked.
