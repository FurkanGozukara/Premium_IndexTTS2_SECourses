...
7. **Use:** after a checkpoint is saved, select **Use best checkpoint**, which opens the Voice Generation tab with that LoRA / DoRA selected. Strength 1.0 reproduces the trained scale.
